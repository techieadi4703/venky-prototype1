...
export function WorkCarousel() {
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden flex items-center justify-center">
      ...
      {/* Main Content Area */}
      <div className="relative z-10 w-full max-w-[1440px] mx-auto px-4 md:px-12 flex items-center justify-between mt-16">
        ...
        {/* Carousel Content */}
        <div className="flex-1 max-w-5xl mx-auto flex items-stretch h-[60vh] md:h-[70vh]">
          
          {/* Left Detail Panel */}
          <div className="w-1/3 bg-black/40 border border-white/10 p-8 flex flex-col justify-center relative">
          ...
          {/* Right Slider Panel */}
          <div className="w-2/3 border border-white/10 border-l-0 bg-ink relative">
            <BeforeAfterSlider 
